...
public class CardDetailsController {
	...
	@Autowired
	private CardDetailsInfoService cardDetailsInfoService;
	...
	public ResponseEntity getInfo(@PathVariable("cardNumber") String cardNumber) {
		return new ResponseEntity<>(cardDetailsInfoService.getCardInfo(cardNumber),HttpStatus.OK);
	}
	...
	public ResponseEntity getStatistics(@RequestParam(value = "start", defaultValue = "0") int start,
		...
		return new ResponseEntity<>(cardDetailsInfoService.getCardStats(start, limit), HttpStatus.OK);
	}
